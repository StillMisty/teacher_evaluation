      ...
      >
        <template v-for="teacherGrade in Props.teacherGrades" :key="teacherGrade.name">
          <div class="TeacherGeade">
            <p class="TeacherGradeName">
              <el-text>{{ teacherGrade.name }} :</el-text>
            </p>
            <el-rate v-model="teacherGrade.value" disabled show-score> </el-rate>
          </div>
        </template>
      </el-tab-pane>
        ...
        >
          ...
          <div>
            <template v-for="grade in PersonalGrade" :key="grade.key">
              <div class="TeacherGeade">
                <p class="TeacherGradeName">
                  <el-text>{{ grade.name }} :</el-text>
                </p>
                <el-rate v-model="grade.value" show-score clearable :disabled="isPostScores">
                </el-rate>
              </div>
            </template>
          </div>
