<template>
  <div class="main">
    <HomePage :base-url="baseUrl" :search-teacher="searchTeacher" :is-search="search"></HomePage>
    <section class="AfterSearch" v-if="search">
      <TeacherBrief v-bind="teacher"></TeacherBrief>
      <TeacherInfo :teacher-infos="teacher.columnInfo"></TeacherInfo>
      <TeacherGrade
        :teacher-grades="teacherGrades"
        :teacher-id="teacher.id"
        :base-url="baseUrl"
        :updata-comments="undataComments"
      ></TeacherGrade>
